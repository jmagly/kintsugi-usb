...
- **Open issues (9)**: #34, #35, #36 (wizard rewire — code landed 2026-05-25; remaining: IDE option + #37 run), #37, #42 (Ventoy build), #43 (offline-AI core **landed**; IDE decision + casper-safe config remain), #44 (doc reconciliation — **all criteria met 2026-05-25, recommend close**), #41 (release, gated), #19 (v1.1 signing). Everything else (#1–#33, #38, #39, #40) is closed.
